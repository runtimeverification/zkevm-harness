...
fn main() {
    ...
    let expected_init_byte = unsafe { DATA[OFFSET + INDEX] };
    ...
    let CreateInputs {
        caller: _,
        scheme: CreateScheme::Create2 { salt: actual_salt },
        value: actual_value,
        init_code,
        gas_limit: _,
    } = *inputs
    ...
    assert_eq!(actual_init_byte, expected_init_byte);
}
